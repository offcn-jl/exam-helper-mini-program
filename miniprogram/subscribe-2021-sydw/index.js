...
Page({
   ...
   */
  data: {
    CRMEFSID: "fd8a74727d4510f67488a57c667e69a2", // CRM 活动表单 ID
    CRMRemark: "活动编码:HD202102050013,活动表单ID:73279", // CRM 注释
  ...
  register: function (e) {
    ...
    getApp().methods.register(e, this.data.suffix, this.data.CRMEFSID, "意向报考地市:" + this.data.cityValue + ",意向报考岗位类别:" + this.data.typeValue + "," + this.data.CRMRemark, phone => {
      this.setData({ phone })
  ...
  onLoad: function (options) {
    ...
    if (wx.getLaunchOptionsSync().scene !== 1154) {
      getApp().methods.login(this.data.CRMEFSID, this.data.suffix, "意向报考地市:" + this.data.cityValue + ",意向报考岗位类别:" + this.data.typeValue + "," + this.data.CRMRemark, phone => this.setData({ phone })) // 登陆
    }
  },
  ...
  */
  onShareAppMessage: function () {
    return {
      title: '免费事业单位考试公告订阅服务',
      imageUrl: 'http://jl.offcn.com/zg/ty/images/exam-helper-mini-program/subscribe/2021/sydw/share-202102051032.jpg'
    }
  },
