Page({
  data: {
    title:"职位筛选-2021特岗教师",// 标题
    banner_bk:"http://jl.offcn.com/zg/ty/images/exam-helper-mini-program/position/2021/2021zwsy-tgjs-header.jpg",// 背景图片
    imageUrl:"http://jl.offcn.com/zg/ty/images/exam-helper-mini-program/position/2021/2021zwsy-tgjs-share.jpg",// 分享时显示的图片
    ...
    actid:"37044", //zg99id  2021特岗教师职位筛选
  ...
  m_select_touch(e) {
    ...
    switch (e.detail.type) {
      case "city": //县（市、区）
        ...
        break
      case "county": //县（市、区）
        console.log(_this.data.countyList[e.detail.index])
