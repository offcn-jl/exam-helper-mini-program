Page({
    ...
    onLoad: function (options) {
        ...
        // 渲染奖品
        const awards = [
            { name: '教基网校付费课程', remark: '活动结束后，三个工作日内将会有工作人员致电您确认领取方式。如有疑问可拨打：0431-81239600,0431-81239633。' },
            { name: '万人易错题（上下册）', remark: '活动结束后，三个工作日内将会有工作人员致电您确认领取方式。如有疑问可拨打：0431-81239600,0431-81239633。' },
            { name: '六本套大礼包', remark: '活动结束后，三个工作日内将会有工作人员致电您确认领取方式。如有疑问可拨打：0431-81239600,0431-81239633。' },
            { name: '公基：通用知识模拟试卷', remark: '活动结束后，三个工作日内将会有工作人员致电您确认领取方式。如有疑问可拨打：0431-81239600,0431-81239633。' },
            { name: '教基+公基+幼儿电子版备考资料', remark: '活动结束后，三个工作日内将会有工作人员致电您确认领取方式。如有疑问可拨打：0431-81239600,0431-81239633。' },
            { name: '隐藏版：教育基础知识题6000题（上下两册共四本）', remark: '活动结束后，三个工作日内将会有工作人员致电您确认领取方式。如有疑问可拨打：0431-81239600,0431-81239633。' },
            { name: '再试一次', remark: '' },
        ];
