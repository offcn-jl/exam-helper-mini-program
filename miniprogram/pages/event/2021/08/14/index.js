Page({
    ...
    data: {
        ...
        CRMEFSID: "4a840bc28bb25ca22cba5320971a6efa", // CRM 活动表单 ID
        CRMRemark: "活动编码:HD202108140234,活动表单ID:96631", // CRM 注释
    ...
    onLoad: function (options) {
        ...
        const awards = [
            ...
            { name: '三等奖', remark: '活动结束后，一个工作日内将会为您开通课程。请注意：1. 开课账号为您本次登陆使用的手机号码；2. 听课网址为：19.offcn.com；3.手机端可以下载19课堂app听课；4.登陆平台后在“我的课程”或“学员专享”内查看。' },
            { name: '四等奖', remark: '活动结束后，一个工作日内将会为您开通课程。请注意：1. 开课账号为您本次登陆使用的手机号码；2. 听课网址为：19.offcn.com；3.手机端可以下载19课堂app听课；4.登陆平台后在“我的课程”或“学员专享”内查看。' },
            { name: '再试一次', remark: '' },
        ];
