...
Page({
  data: {
    yearList: ["不限", "2020年", "2019年", "2018年", "2017年", "2016年", "2020年"],
  ...
  tipsToSubscribeMessage() {
    ...
    if (!_this.data.tipsToSubscribeMessaged) {
      ...
      wx.showModal({
        ...
        success(res) {
          if (res.confirm) {
            getApp().methods.subscribeSingleExam(_this.data.suffix, _this.data.phone, "吉林公务员", undefined, () => {
