...
Page({
                ...
                wx.request({
                    ...
                    success(res) {
                        ...
                        for (var i = 0; i < response.lists.length; i++) {
                            ...
                            dwList.push(response.lists[i].item02)
                        }
                        _this.setData({
                            dwList
                        })
                            ...
                            success(res) {
                                try {
                                    ...
                                    for (var i = 0; i < list.lists.length; i++) {
                                        dqList.push(list.lists[i].item01)
    ...
    onReachBottom: function () {
        if (this.data.dqValue !== "" && this.data.bankValue !== "" && this.data.provenceValue !== "" && this.data.cityValue !== "" && this.data.graduatesValue !== "" && this.data.cetValue !== "" && this.data.result.length < this.data.count) {
            this.search();
        }
    },
