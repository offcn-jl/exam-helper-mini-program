...
Page({
    ...
    search() {
        ...
        wx.request({
            ...
            data: {
                ...
                item03: this.data.xqValue,
                item04: this.data.xkValue,
                ...
                success(res) {
                    try {
                        ...
                        _this.setData({
                            ...
                            CRMRemark: `${response.lists[0].title}`,
    ...
    onReachBottom: function () {
        if (this.data.dsValue !== "" && this.data.xqValue !== "" && this.data.result.length < this.data.count) {
            this.search();
        }
    },
