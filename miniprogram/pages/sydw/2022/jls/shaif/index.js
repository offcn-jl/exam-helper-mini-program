...
Page({
     ...
     */
    data: {
        title: "2022年吉林市事业单位晒分系统", // 标题
        banner_bk: "https://jl.offcn.com/zt/ty/2022images/exam-helper-mini/sydw-sf-jls-index.jpg", // 背景图片
        imageUrl: "https://jl.offcn.com/zt/ty/2022images/exam-helper-mini/sydw-sf-jls-share.jpg", // 分享时显示的图片
        CRMEFSID: "cf7623a9fc5391a60e55f205aed2be57", // CRM 活动表单 ID
        CRMRemark: "2022年吉林市事业单位晒分系统", // CRM 注释
        actid: "50477", //zg99id
                ...
                wx.request({
                    ...
                    success(res) {
                        ...
                        for (var i = 0; i < county_list.lists.length; i++) {
                            _this.setData({
                                departmentList: _this.data.departmentList.concat(county_list.lists[i].department)
                            });
                        };
                    },
                    fail: err => { // 获取失败后提示
            ...
            case "employer":
                ...
                wx.request({
                    ...
                    data: {
                        ...
                        onetext: this.data.cityValue,
                        twofiled: 'department',
                        twotext: this.data.departmentValue,
                        sstime: new Date().valueOf()
                    }, //二级联动，上级联动字段名，上级联动参数值
                    success(res) {
