...
Page({
    ...
    m_select_touch(e) {
        ...
        switch (e.detail.type) {
            case "department":
                ...
                console.log(_this.data.departmentList);
                wx.request({
                    url: "https://zg99.offcn.com/index/shaifen/getlevel?actid=", //路径
                    data: {
    ...
    onLoad: function (options) {
        ...
        getApp().methods.getSuffix(options).then(res => {
            ...
            // 获取活动配置  
            wx.request({
                url: "https://zg99.offcn.com/index/shaifen/getfzinfo",
                data: {
                    actid: options.actid,
                    sstime: new Date().valueOf()
                },
                success(res) {
                    try {
                        ...
                        _this.setData({
                            ...
                            banner_bk: response.lists[0].banner_bk,
            ...
            // 获取数据
            wx.request({
                url: "https://zg99.offcn.com/index/shaifen/getlevel?actid=",
                data: {
                    actid: options.actid,
                    level: "1",
                    grfiled: '',
