// pages/zh/2022/szyf/lnfs/index.js
Page({
     ...
     */
    data: {
        title:"吉林三支一扶历年进面分数查询",
        imageUrl:"http://jl.offcn.com/zg/ty/images/exam-helper-mini-program/zh/szyf/lnfs/share.jpg",
        CRMEFSID: "34f06083ea1986393db815bc0700af29", // CRM 活动表单 ID
        CRMRemark: "活动编码:HD202207050736,活动表单ID:134909", // CRM 注释  小程序-2023银行秋招职位查询
        actid: "49337", // zg99id  
                ...
                wx.request({
                    ...
                    success(res) {
                        ...
                        for (var i = 0; i < response.lists.length; i++) {
                            dwList.push(response.lists[i].dw)
                        }
                        _this.setData({
                            dwList
                        })
    ...
    search() {
        ...
        wx.request({
            ...
            data: {
                nf: this.data.yearValue,
                dw: this.data.dwValue,
                zw: this.data.zwValue,
                limits: 200,
                page: this.data.page
            },
            success(res) {
