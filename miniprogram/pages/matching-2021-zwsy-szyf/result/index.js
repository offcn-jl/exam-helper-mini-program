...
Page({
  data: {
    ...
    superiorLink:"/pages/matching-2021-zwsy-szyf/index", //上级链接
  ...
  onLoad: function (options) {
    ...
    if (typeof options.gwlb !== "undefined" && options.gwlb !== "不限") this.setData({ "query.gwlb": options.gwlb })
    if (typeof options.xl !== "undefined" && options.xl !== "不限") this.setData({ "query.xl": options.xl })
    if (typeof options.major !== "undefined") this.setData({ "query.major": options.major })
    this.search();
  },
  /**
   * 生命周期函数--监听页面初次渲染完成
