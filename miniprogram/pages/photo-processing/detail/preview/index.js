...
Page({
    ...
    beautify: function () {
        ...
        wx.cloud.callFunction({
            ...
            data: {
                ...
                hashedRequestPayload: require('../../../../utils/sha256').sha256_digest(JSON.stringify({ Image: this.originImg, Whitening: 20 * this.data.whitening, Smoothing: 20 * this.data.buffing, FaceLifting: 1, EyeEnlarging: 1 })),
            },
            success: res => {
                // 使用签名调用腾讯云接口进行人脸美颜
                if (res.errMsg === 'cloud.callFunction:ok' && res.result != null) {
    ...
    onShareAppMessage: function () {
        return {
            ...
            path: `/pages/photo-processing/detail/index?scene=${this.data.suffix}*${this.data.config.ID}`,
