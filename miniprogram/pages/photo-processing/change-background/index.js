...
Page({
    ...
    data: {
        suffix: '', // 推广后缀
        CRMRemark: '活动表单ID:92560;中公证件照;换底色;', // CRM 推送备注
    ...
    pickPhoto: function (e) {
        ...
        wx.cloud.callFunction({
            ...
            data: {
                ...
                hashedRequestPayload: require('../../../utils/sha256').sha256_digest(JSON.stringify({ Image: wx.getFileSystemManager().readFileSync(e.detail, "base64") })),
            },
            success: res => {
                // 使用签名调用腾讯云接口进行人像分割
                            ...
                            wx.saveImageToPhotosAlbum({
                                ...
                                success: function () {
                                    ...
                                    wx.showModal({
                                        ...
                                        confirmText: "去查看",
                                        success: function (res) {
                                            if (res.confirm) wx.navigateTo({ url: "../album/index" });
                                        }
                                    });
                                },
                                fail: err => {
